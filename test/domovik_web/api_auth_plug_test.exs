defmodule DomovikWeb.APIAuthPlugTest do
  use DomovikWeb.ConnCase
  doctest DomovikWeb.APIAuthPlug

  alias DomovikWeb.{APIAuthPlug, Endpoint}
  alias Domovik.{Repo, Users.User}

  @pow_config [otp_app: :domovik]
